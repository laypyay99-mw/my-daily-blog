          ...
          {isAdmin ? (
            <div>
                ...
                <div className="text-center mb-8">
                    <button onClick={handleLogout} className="text-sm text-gray-500 hover:underline px-4">Logout</button>
                    <button onClick={() => setShowChangePassword(!showChangePassword)} className="text-sm text-gray-500 hover:underline px-4">Change Password</button>
                </div>
                {showChangePassword && (
                    <div className="bg-white p-5 rounded-xl shadow-sm mb-8 border border-gray-200">
                        ...
                        <input
                            ...
                            className="w-full p-3 mb-3 text-sm border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        />
                        <button onClick={handleChangePassword} className="w-full bg-blue-600 text-white py-3 rounded-lg mt-2 font-semibold hover:bg-blue-700 transition-colors">Save Password</button>
                    </div>
                )}
            </div>
          ) : (
